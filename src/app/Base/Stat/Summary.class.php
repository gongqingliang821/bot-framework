...
class Summary extends DBModel{
    ...
    public function getFieldList(){
        static $FIELD_LIST=[
            ...
            ['name'=>'service_code','type'=>"string",'key'=>false,'defalut'=>'','null'=>false,],
            ['name'=>'service_name','type'=>"string",'key'=>false,'defalut'=>'','null'=>false,],
            ['name'=>'call_time','type'=>"string",'key'=>false,'defalut'=>'0000-00-00','null'=>false,],
            ['name'=>'inc_num','type'=>"int",'key'=>false,'defalut'=>'0','null'=>false,],
            ['name'=>'sum_num','type'=>"int",'key'=>false,'defalut'=>'0','null'=>false,],
