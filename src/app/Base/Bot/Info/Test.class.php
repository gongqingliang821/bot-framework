...
class Test extends DBModel{
    ...
    public function getFieldList(){
        static $FIELD_LIST=[
            ...
            ['name'=>'resource_url','type'=>"string",'key'=>false,'defalut'=>'','null'=>false,],
            ['name'=>'resource_intr','type'=>"string",'key'=>false,'defalut'=>'','null'=>false,],
            ['name'=>'resource_info','type'=>"string",'key'=>false,'defalut'=>NULL,'null'=>true,],
            ['name'=>'fallback_words','type'=>"string",'key'=>false,'defalut'=>'','null'=>false,],
            ...
            ['name'=>'require_bd_login','type'=>"int",'key'=>false,'defalut'=>'0','null'=>false,],
            ['name'=>'require_tp_login','type'=>"int",'key'=>false,'defalut'=>'0','null'=>false,],
